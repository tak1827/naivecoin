...
const responseChainMsg = () => (new Message(
  MessageType.RESPONSE_BLOCKCHAIN, JSON.stringify(getBlockchain())
));

const responseLatestMsg = () => (new Message(
  MessageType.RESPONSE_BLOCKCHAIN, JSON.stringify([getLatestBlock()])
));

const queryTransactionPoolMsg = () => (new Message(
  MessageType.QUERY_TRANSACTION_POOL, null
));

const responseTransactionPoolMsg = () => (new Message(
  MessageType.RESPONSE_TRANSACTION_POOL, JSON.stringify(getTransactionPool())
));
